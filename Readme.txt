...
Usa alguno de los métodos de ciclo de vida y el estado, no tiene que ser algo complejo puede ser usado para crear una funcionalidad o mostrar algún texto o información simple
